#
#  Be sure to run `pod spec lint WZPhotoBrowser.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "http://iOSdefault:123456@test.game.xiaoyouapp.cn:20080/iOS/WZPhotoBrowser.git", :tag => "#{s.version}" }
